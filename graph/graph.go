...
func (g Graph) String() string {
	nodeStrings := make([]string, 0, len(g.Edges)+len(g.ArgumentEdges)+len(g.ConditionEdges)+3)
...
// ID returns the node ID
func (n *RootNode) ID() IsID { return n.id }

func (n *RootNode) setID(id IsID) { n.id = id }
